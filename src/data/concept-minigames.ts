...
export const CONCEPT_MINIGAMES: ConceptMinigame[] = [
  ...
  },
  {
    ...
    challenge: {
      type: 'sort',
      instruction: 'Tap only the FISH to sort them into the fish bin!',
      items: ['🐟 Tuna', '🪨 Rock', '🐚 Shell', '🪸 Coral', '🐟 Salmon'],
      answer: [0, 4],
      successText: 'Perfectly sorted! You\'re a classification expert!',
      hintText: 'Only pick items that are fish — skip rocks, shells, and coral!',
    },
